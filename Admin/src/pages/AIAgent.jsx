      ...
      <div className="bg-violet-50 border border-violet-200 rounded-2xl p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-violet-600 mt-0.5">
            ...
            {list.length === 0 && <span className="block mt-1 text-amber-600 font-medium">⚠️ No numbers added yet — the bot will not reply to anyone until you add at least one.</span>}
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-dark-100 overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="py-12 text-center text-dark-400">
            ...
            <p className="text-sm">No numbers added — bot will not reply to anyone</p>
          </div>
        ) : (
